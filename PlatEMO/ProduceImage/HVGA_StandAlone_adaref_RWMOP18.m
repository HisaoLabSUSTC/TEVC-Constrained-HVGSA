...
algorithmConfig = struct('eta', 1e-3);
...
% filename = sprintf('ProduceImage/images/HVGA_obj_adaref_%s.png', func2str(Problem));
% exportgraphics(gcf, filename, 'Resolution', 300);
% close(gcf);
%
% filename = sprintf('ProduceImage/images/HVGA_dec_adaref_%s.png', func2str(Problem));
% exportgraphics(gcf, filename, 'Resolution', 300);
% close(gcf);
