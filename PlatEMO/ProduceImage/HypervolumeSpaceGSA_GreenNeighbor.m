...
x1 = [0.33, 0.71]; % Green (neighbor)
x2 = [0.22, 0.68]; % Green (neighbor)
...
% Blue population
plot(x2(1), x2(2), 'gs', 'Color', [0.3 0.75 0.93], 'MarkerSize', 26, ...
    'MarkerFaceColor', 'g', 'MarkerEdgeColor', 'k', 'LineWidth', 1.5);
...
filename = 'ProduceImage/images/HVSpaceGSA-oneNeighbor.pdf';
