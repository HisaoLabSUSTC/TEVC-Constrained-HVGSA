...
algorithmConfig = struct('eta', 1e-3, 'gradient_method', 'CGSA_n', 'neighbor_mode', 'archive', 'a', 1);
...
% fig1 = figure(1);
% filename = sprintf('%s_HVGSA_dec_adaref_%d.png', problemName, max_iter);
% exportgraphics(fig1, fullfile(imgDir, filename), 'Resolution', 500);
% 
% fig2 = figure(2);
% filename = sprintf('%s_HVGSA_obj_adaref_%d.png', problemName, max_iter);
