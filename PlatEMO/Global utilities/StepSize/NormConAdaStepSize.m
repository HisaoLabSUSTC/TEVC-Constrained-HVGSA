function [tested_phis, tested_etas, Xs, trajectory, base_eta] = ...
        NormConAdaStepSize(eta_ub, X0, ref, gradient, d, V, lambda, Problem, NormStruct, max_iter, c1_coeff)
    ...
    % Line search loop
    [tested_phis, tested_etas, Xs, trajectory, base_eta] = performLineSearch(phi0, phi_prime0, eta_ub, X0, ...
            gradient, Problem, ref, c1_coeff, max_iter, MIN_ETA, CHVmode, NormStruct);
end

function [tested_phis, tested_etas, Xs, trajectory, base_eta] = ...
        performLineSearch(phi0, phi_prime0, eta_ub, X0, ...
